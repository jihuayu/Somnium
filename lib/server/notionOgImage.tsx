...
import type { loadOgFonts } from '@/lib/server/notionOg'
...
export function normalizeOgText(value: string, limit: number): string {
...
function createSvgFallbackMarkup({
  ...
  const safeTitle = normalizeOgText(title || config.title, 120) || config.title
